...
object BEQZ: Instruction(
    name = "BEQZ",
    longname = "Branch if Equal to Zero",
    ...
    description = """Wenn Rs1 gleich 0 ist, springe zu den angegeben Label.
    ...
    usage = listOf("Verzweigungen", "Schleifen", "Wenn BNEZ das Gegenteil von dem tut, was man will"),
    seeAlso = listOf(Reference.negatedVersion("BNEZ")),
